...
- Bench Neural · Charge — Paused Bench Press
- Bench Neural · Charge — Paused Bench Press
- Squat Neural · Charge — Low Bar Squat
- Squat Neural · Charge — Low Bar Squat
- Squat Neural · Charge — Low Bar Squat
- Squat Neural · Charge — Low Bar Squat
...
| | |
|---|---|
| **Save-time handler** | its own rule — `PROGRESSION_HANDLERS['neural-overload']` — composed on top of the shared double progression |
...
progression: { handler: own+double, slot_rules: true, distinct_rules: 3 }
