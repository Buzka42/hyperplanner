export const translations = {
    en: {
        ...
        tips: {
            ...
            pausedBenchAMRAP: "AMRAP drives progression! Weeks 1-6: ≥12 reps, Weeks 7-9: ≥10 reps, Weeks 10-12: ≥8 reps, Peaking: ≥6 reps = +2.5 kg next week. Sustainable progression – no large jumps, no microplates.",
            ...
            "Low Bar Squat (ME)": "General warm-up (see Squat warm-up tip above) → Barbell warm-up: Empty bar × 8-10, 50% × 5, 70% × 3, 85% × 2, 95% × 1. All paused. Max Effort single.",
            "Low Bar Squat (Light)": "General warm-up (see Squat warm-up tip above) → Barbell warm-up: Empty bar × 8-10, 50% × 5, 70% × 3 (skip 85%, 95%). All paused. Light work @ 70% for speed.",
            "Low Bar Squat (Ascension Test)": "General warm-up (see Squat warm-up tip above) → Barbell warm-up: Empty bar × 8-10, 50% × 5, 70% × 3, 85% × 2. All paused. ASCENSION TEST.",
            "Conventional Deadlift (ME)": "General warm-up (see Deadlift warm-up tip above) → Barbell warm-up: Empty bar × 8-10, 50% × 5, 70% × 3, 85% × 2, 95% × 1. All paused off floor. Max Effort single.",
            "Conventional Deadlift (Light)": "General warm-up (see Deadlift warm-up tip above) → Barbell warm-up: Empty bar × 8-10, 50% × 5, 70% × 3 (skip 85%, 95%). All paused. Light work @ 70% for speed.",
            "Conventional Deadlift (Ascension Test)": "General warm-up (see Deadlift warm-up tip above) → Barbell warm-up: Empty bar × 8-10, 50% × 5, 70% × 3, 85% × 2. All paused. ASCENSION TEST.",
            "Conventional Deadlift": "General warm-up (see Deadlift warm-up tip above) → Barbell warm-up: Empty bar × 8-10, 50% × 5, 70% × 3, 85% × 2, 95% × 1 (heavy days). All paused off floor.",
            "Low Bar Squat": "General warm-up (see Squat warm-up tip above) → Barbell warm-up: Empty bar × 8-10, 50% × 5, 70% × 3, 85% × 2, 95% × 1 (heavy days). All paused.",
            ...
            "Deficit Snatch Grip Deadlift": "General warm-up (see Deadlift warm-up tip above) → Barbell warm-up: Empty bar × 8-10, 50% × 5, 70% × 3 (lighter due to deficit + snatch grip). 4 sec eccentric. Max 2 min rest. Do NOT cheat eccentric.",
    ...
    pl: {
        ...
        tips: {
            ...
            "Low Bar Squat (ME)": "Rozgrzewka ogólna (patrz powyżej – rozgrzewka przysiadu) → Rozgrzewka sztangą: Pusty gryf × 8-10, 50% × 5, 70% × 3, 85% × 2, 95% × 1. Wszystkie z pauzą. Max Effort singiel.",
            "Low Bar Squat (Light)": "Rozgrzewka ogólna (patrz powyżej – rozgrzewka przysiadu) → Rozgrzewka sztangą: Pusty gryf × 8-10, 50% × 5, 70% × 3 (pomiń 85%, 95%). Wszystkie z pauzą. Lekka praca @ 70% na prędkość.",
            "Low Bar Squat (Ascension Test)": "Rozgrzewka ogólna (patrz powyżej – rozgrzewka przysiadu) → Rozgrzewka sztangą: Pusty gryf × 8-10, 50% × 5, 70% × 3, 85% × 2. Wszystkie z pauzą. TEST ASCENSJI.",
            "Conventional Deadlift (ME)": "Rozgrzewka ogólna (patrz powyżej – rozgrzewka martwego ciągu) → Rozgrzewka sztangą: Pusty gryf × 8-10, 50% × 5, 70% × 3, 85% × 2, 95% × 1. Wszystkie z pauzą od podłogi. Max Effort singiel.",
            "Conventional Deadlift (Light)": "Rozgrzewka ogólna (patrz powyżej – rozgrzewka martwego ciągu) → Rozgrzewka sztangą: Pusty gryf × 8-10, 50% × 5, 70% × 3 (pomiń 85%, 95%). Wszystkie z pauzą. Lekka praca @ 70% na prędkość.",
            "Conventional Deadlift (Ascension Test)": "Rozgrzewka ogólna (patrz powyżej – rozgrzewka martwego ciągu) → Rozgrzewka sztangą: Pusty gryf × 8-10, 50% × 5, 70% × 3, 85% × 2. Wszystkie z pauzą. TEST ASCENSJI.",
            "Conventional Deadlift": "Rozgrzewka ogólna (patrz powyżej – rozgrzewka martwego ciągu) → Rozgrzewka sztangą: Pusty gryf × 8-10, 50% × 5, 70% × 3, 85% × 2, 95% × 1 (ciężkie dni). Wszystkie z pauzą od podłogi.",
            "Low Bar Squat": "Rozgrzewka ogólna (patrz powyżej – rozgrzewka przysiadu) → Rozgrzewka sztangą: Pusty gryf × 8-10, 50% × 5, 70% × 3, 85% × 2, 95% × 1 (ciężkie dni). Wszystkie z pauzą.",
            ...
            "Deficit Snatch Grip Deadlift": "Rozgrzewka ogólna (patrz powyżej – rozgrzewka martwego ciągu) → Rozgrzewka sztangą: Pusty gryf × 8-10, 50% × 5, 70% × 3 (lżejsze %: deficyt + snatch grip). 4 sek ekscentryk. Max 2 min odpoczynek. NIE oszukuj przy koncentryku.",
