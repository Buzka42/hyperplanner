export const translations = {
    en: {
        ...
        entry: {
            ...
            button: "ENTER",
            keywordUnknown: "That keyword is not registered. Check the spelling, or create a new one below.",
            creationUnavailable: "New keyword registration is currently unavailable.",
            freeOnlyNote: "A keyword you create yourself includes the free plans. Anything else is issued to you.",
            keywordClaimed: "This keyword is already in use on another device. Open it there, or ask for a new keyword.",
        ...
        dashboard: {
            ...
            cards: {
                ...
                weeklySetsDesc: "Completed working sets in the last seven days.",
    ...
    pl: {
        ...
        entry: {
            ...
            button: "WEJDŹ",
            keywordUnknown: "To hasło nie jest zarejestrowane. Sprawdź pisownię albo utwórz nowe poniżej.",
            creationUnavailable: "Rejestracja nowych haseł jest chwilowo niedostępna.",
            freeOnlyNote: "Hasło utworzone samodzielnie zawiera darmowe plany. Pozostałe są przydzielane.",
            keywordClaimed: "To hasło jest już używane na innym urządzeniu. Otwórz je tam albo poproś o nowe.",
        ...
        dashboard: {
            ...
            cards: {
                ...
                weeklySets: "Serie w tym tygodniu",
                weeklySetsDesc: "Ukończone serie robocze z ostatnich siedmiu dni.",
