...
const CORE_LIBRARY: LibraryExercise[] = [
    ...
    },
    {
        ...
        name: { en: 'Barbell Romanian Deadlift (legacy id)', pl: 'Martwy ciąg rumuński ze sztangą' },
        aliases: [],
        pattern: 'hinge',
        ...
        weightMode: 'external',
        status: 'deprecated',
        deprecatedFor: 'romanian-deadlift',
    },
    {
        id: 'barbell-row',
    ...
    {
        id: 'bodyweight-dip',
        name: { en: 'Bodyweight Dips (legacy id)', pl: 'Pompki na poręczach' },
        aliases: [],
    ...
    },
    {
        ...
        name: { en: 'Dumbbell Hammer Curl (legacy id)', pl: 'Uginanie młotkowe z hantlami' },
        aliases: [],
        pattern: 'elbow-flexion',
    ...
    },
    {
        ...
        aliases: ['Dumbbell Hammer Curl', 'Hammer Curl', 'KB Hammer Curl'],
        pattern: 'elbow-flexion',
        primary: ['brachialis', 'forearms'],
        secondary: ['biceps'],
        equipment: ['dumbbell'],
    ...
    },
    {
        ...
        aliases: ['Goblet Heel-Elevated Squat', 'Goblet Squat Heels Elevated', 'Heel Elevated Goblet Squat'],
        pattern: 'squat',
        primary: ['quads', 'glutes'],
        secondary: ['hamstrings', 'adductors'],
        equipment: ['dumbbell'],
    ...
    },
    {
        ...
        name: { en: 'Cable Low-Pulley Curl', pl: 'Uginanie ramion z dolnego wyciągu' },
        aliases: ['Low-Pulley Cable Curl'],
        pattern: 'elbow-flexion',
        primary: ['biceps'],
        secondary: ['brachialis'],
        equipment: ['cable'],
    ...
    },
    {
        ...
        aliases: ['RDLs', 'Barbell Romanian Deadlift'],
        pattern: 'hinge',
        primary: ['hamstrings', 'glutes'],
        secondary: ['lowerBack'],
        equipment: ['barbell'],
    ...
    {
        id: 'rope-hammer-curl',
        name: { en: 'Cable Rope Hammer Curl', pl: 'Uginanie ramion na wyciągu z liną (młotkowe)' },
    ...
    {
        id: 'rope-pressdown',
        name: { en: 'Cable Rope Pressdown', pl: 'Prostowanie ramion na wyciągu z liną' },
    ...
    },
    {
        ...
        name: { en: 'Cable Straight-Bar Curl', pl: 'Uginanie ramion na wyciągu z prostym drążkiem' },
    ...
    },
    {
        ...
        name: { en: 'Supported Stiff Legged DB Deadlift (legacy id)', pl: 'Martwy ciąg na prostych nogach z hantlami (z podparciem)' },
        aliases: [],
        pattern: 'hinge',
        primary: ['hamstrings', 'glutes'],
        secondary: ['lowerBack'],
        ...
        weightMode: 'external',
        status: 'deprecated',
        deprecatedFor: 'hip-supported-db-deadlift',
    },
    {
        id: 'tempo-squat',
    ...
    },
    {
        ...
        name: { en: 'Cable Triangle Pressdown', pl: 'Prostowanie ramion na wyciągu z rączką trójkątną' },
        aliases: ['Triangle Pushdown'],
        pattern: 'elbow-extension',
        primary: ['triceps'],
        equipment: ['cable'],
        weightMode: 'external',
    ...
    },
    {
        id: 'tricep-extension',
        tip: { en: 'Accessory work chosen for a weak point. Full range, controlled, no swing.', pl: 'Ćwiczenie akcesoryjne na słaby punkt. Pełny zakres, pod kontrolą, bez zamachu.' },
        name: { en: 'Cable Pressdown', pl: 'Prostowanie ramion na wyciągu' },
        aliases: ['Tricep Extensions'],
        pattern: 'elbow-extension',
        primary: ['triceps'],
        equipment: ['cable'],
        weightMode: 'external',
