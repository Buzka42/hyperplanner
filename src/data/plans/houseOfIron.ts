...
const days: DaySpec[] = [
    ...
    },
    {
        name: 'Push B — Shoulders + Quads/Glutes', dayOfWeek: 3, slots: [
            ...
            { ex: 'supported-sissy-squat', sets: 2, reps: '10-20', restSeconds: 75 },
            { ex: 'lateral-raise', sets: 2, reps: '12-25', restSeconds: 60, notes: 'Shorten the lever if the available bell is too heavy.' },
