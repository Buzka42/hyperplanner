...
const days: DaySpec[] = [
    // The access work leads every session. It is what the assessment
    // prescribed and what the block is for; buried behind five loaded
    // movements it gets done tired, or not at all.
