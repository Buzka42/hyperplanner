...
export const CHIMERA_DAYS: DaySpec[] = [
    { name: 'Chimera — Upper A', dayOfWeek: 1, slots: [
        ...
        s('lateral-raise', 3, '12-15', 'hypertrophy'),
        s('hammer-curl', 2, '8-12', 'hypertrophy'),
        s('cable-triceps-extension', 2, '10-15', 'hypertrophy'),
    ] },
    { name: 'Chimera — Lower A', dayOfWeek: 2, slots: [
        ...
        s('leg-extension', 3, '12-15', 'hypertrophy'),
    ...
    { name: 'Chimera — Upper B', dayOfWeek: 4, slots: [
        ...
        s('single-arm-reverse-pec-deck', 3, '12-15', 'hypertrophy', { unilateral: true }),
        s('cable-triceps-extension', 2, '10-15', 'hypertrophy'),
        s('hammer-curl', 2, '8-12', 'hypertrophy'),
    ] },
