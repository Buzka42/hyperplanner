...
export const KALI_DAYS: DaySpec[] = [
    { name: 'I — Earth', dayOfWeek: 1, slots: [s('high-bar-squat', 3, '3-6', { systemicCompound: true }), s('leg-press', 2), s('front-foot-elevated-bulgarian-split-squat', 2, '8-12', { unilateral: true }), s('seated-hamstring-curl', 2, '10-15'), s('hammer-pulldown', 3, '8-12', { unilateral: true }), s('cable-lateral-raise', 2, '12-20'), s('hack-calf-raise', 2, '12-20'), s('triangle-pushdown', 2, '10-15')] },
    ...
    { name: 'IV — Rebirth', dayOfWeek: 5, slots: [s('paused-bench-press', 3, '3-6', { systemicCompound: true }), s('dip', 2), s('single-arm-hammer-row', 3, '8-12', { unilateral: true }), s('single-leg-hip-thrust', 3, '8-12', { unilateral: true }), s('bench-supported-single-arm-cable-pulldown', 2), s('lying-leg-curl', 2, '10-15'), s('lateral-raise', 2, '12-20'), s('30-incline-lying-dumbbell-curl', 2, '10-15')] },
];
