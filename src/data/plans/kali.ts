...
/**
 * 8-12 is the default for the loaded volume work that sits behind each day's
 * heavy anchor. The anchors state their own low range, and the movements that
 * cannot be loaded at eight reps — delts, calves, abduction — state their own
 * high one.
 */
...
export const KALI_DAYS: DaySpec[] = [
    { name: 'I — Earth', dayOfWeek: 1, slots: [s('high-bar-squat', 3, '3-6', { systemicCompound: true }), s('leg-press', 2), s('front-foot-elevated-bulgarian-split-squat', 2, '8-12', { unilateral: true }), s('seated-hamstring-curl', 2, '10-15'), s('hammer-pulldown', 3, '8-12', { unilateral: true }), s('cable-lateral-raise', 2, '12-20'), s('hack-calf-raise', 2, '12-20'), s('cable-triceps-extension', 2, '10-15')] },
    { name: 'II — Hunt', dayOfWeek: 2, slots: [s('assisted-pull-up', 3, '4-6', { systemicCompound: true }), s('30-smith-incline-bench-press', 2), s('pec-deck', 2), s('single-leg-machine-hip-thrust', 3, '8-12', { unilateral: true }), s('single-arm-hammer-row', 2, '8-12', { unilateral: true }), s('lying-cable-lat-raise', 2), s('machine-curl', 2, '10-15'), s('overhead-tricep-extension', 2, '10-15')] },
    { name: 'III — Death', dayOfWeek: 4, slots: [s('romanian-deadlift', 3, '4-6', { systemicCompound: true }), s('hack-squat', 2), s('leg-extension', 2, '10-15'), s('lat-prayer', 3), s('machine-hip-abduction', 3, '12-20'), s('side-lying-rear-delt-fly', 2, '12-20', { unilateral: true }), s('cable-crunch', 2, '10-15'), s('hack-calf-raise', 2, '12-20')] },
    { name: 'IV — Rebirth', dayOfWeek: 5, slots: [s('paused-bench-press', 3, '3-6', { systemicCompound: true }), s('dip', 2), s('single-arm-hammer-row', 3, '8-12', { unilateral: true }), s('single-leg-hip-thrust', 3, '8-12', { unilateral: true }), s('bench-supported-single-arm-cable-pulldown', 2), s('lying-leg-curl', 2, '10-15'), s('lateral-raise', 2, '12-20'), s('machine-curl', 2, '10-15')] },
];
