...
export const MINIMUM_DAYS: DaySpec[] = [
    ...
    { name: 'Session A', dayOfWeek: 1, slots: [
        ...
        s('hip-supported-db-deadlift', 2, '6-10', { systemicCompound: true }),
    ...
    { name: 'Session B', dayOfWeek: 4, slots: [
        ...
        s('30-smith-incline-bench-press', 2, '8-12'),
        s('close-neutral-grip-lat-pulldown', 2, '8-12'),
        s('seated-hammer-shoulder-press', 2, '8-12'),
        s('single-leg-machine-hip-thrust', 2, '10-15', { unilateral: true }),
        s('bayesian-cable-curl', 2, '10-15'),
        s('overhead-tricep-extension', 2, '10-15'),
        s('standing-calf-raise', 2, '12-20'),
