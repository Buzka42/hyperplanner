# Graph Report - workout planner  (2026-08-20)

## Corpus Check
- 276 files · ~8,298,079 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1226 nodes · 1874 edges · 98 communities detected
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 173 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `07c8288f`
...
1. `empty()` - 42 edges
2. `definePlan()` - 32 edges
3. `useLanguage()` - 27 edges
4. `merge()` - 26 edges
5. `useUser()` - 22 edges
6. `cn()` - 22 edges
7. `genericDoubleProgression()` - 20 edges
8. `workSets()` - 14 edges
9. `buildExerciseIntelligence()` - 13 edges
10. `t()` - 13 edges
...
Cohesion: 0.05
Nodes (60): doubleProgression(), predictionError(), handleSaveSession(), extractPerformanceObservations(), atlasProgression(), accessories(), allSetsReach(), amrapRepThreshold() (+52 more)
...
Cohesion: 0.07
Nodes (17): adventureDraftKey(), adventureResultKey(), buildAdventureSequence(), findPreviousAdventureWeight(), getAdventurePair(), applyHouseProgressions(), houseBalance(), recommendHouseSession() (+9 more)
...
Cohesion: 0.09
Nodes (24): getAdventureExercise(), accuracyTrend(), agg(), jaccard(), mean(), median(), nearest(), pairScores() (+16 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (21): calculateReactiveSetsForMuscle(), generateNextWorkout(), getCurrentCycle(), getIntensificationTechnique(), getMuscleContributions(), getRepRange(), getRIRForWeek(), getRIRMessage() (+13 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (8): buildWeightCalculator(), calibrationExercisesFor(), definePlan(), phaseFor(), requiredStatsFor(), accumulate(), intensify(), roundRest()
...
Cohesion: 0.12
Nodes (22): analysePlan(), generatesPerVisit(), buildPreviewUser(), buildPreviewVariants(), analyseWeek(), credit(), evaluate(), majorOf() (+14 more)
...
Cohesion: 0.16
Nodes (22): round(), best_text_on(), build_theme(), contrast_ratio(), css_hsl(), dominant_colours(), ensure_contrast(), from_hsl() (+14 more)

### Community 14 - "Community 14"
Cohesion: 0.13
Nodes (10): confirm(), baseWeeklySets(), blockFor(), meetsMinimums(), preprocess(), applyMutation(), phenotype(), proposeMutation() (+2 more)

### Community 15 - "Community 15"
Cohesion: 0.15
Nodes (14): save(), diff(), rollback(), bumpPlanVersion(), cacheKey(), emptyDoc(), fetchLibraryMeta(), listPlanConfigVersions() (+6 more)

### Community 16 - "Community 16"
Cohesion: 0.16
Nodes (11): isAccessKeyUsable(), isAlwaysFreePlan(), normalizeKeyword(), withAlwaysFreePlans(), createKey(), saveConfig(), createPublicKeyword(), handleCreate() (+3 more)

### Community 18 - "Community 18"
Cohesion: 0.12
Nodes (10): slotKey(), clampSets(), inScope(), overrideFor(), pickText(), resolveBaseSets(), resolveDay(), resolveTips() (+2 more)

### Community 19 - "Community 19"
Cohesion: 0.14
Nodes (8): benchmarkLiftsFor(), enrolWithoutBenchmarks(), handleAdventureSubmit(), handleBenchmarkSubmit(), handleProgramSelect(), isPlanAllowed(), selectionProfile(), needsPlanSelections()
...
Cohesion: 0.12
Nodes (7): selectVariation(), async(), calculateWeight(), fetchPreviousStats(), initializeEmptyState(), initView(), isAutoLoad()
...
Cohesion: 0.18
Nodes (8): KeywordClaimedError, UserProvider(), canonicalPlanId(), canonicalPlanIds(), normalizeLegacyPlanIds(), getPlan(), statusFieldFor(), getPlanExerciseConfig()
...
Cohesion: 0.23
Nodes (6): backoffPercentFor(), deriveBackoffLoad(), roundToIncrement(), topSetCanProgress(), athenaProgression(), upper()
...
Cohesion: 0.22
Nodes (3): resolveTemplate(), asHistory(), trackedLiftFor()
...
Cohesion: 0.33
Nodes (4): t(), handlePainGlorySubmit(), handleEdit(), renderWorkoutName()
...
Cohesion: 0.38
Nodes (3): round2p5(), techniqueAppliesTo(), techniqueRows()

### Community 44 - "Community 44"
Cohesion: 0.52
Nodes (6): getBlockFromWorkout(), allSetsReach(), liftOf(), progressionForRpe(), queue(), trinaryProgression()
...
- **Why does `useUser()` connect `Community 13` to `Community 33`, `Community 2`, `Community 6`, `Community 41`, `Community 11`, `Community 16`, `Community 17`, `Community 50`, `Community 19`, `Community 21`, `Community 24`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `definePlan()` connect `Community 7` to `Community 1`, `Community 2`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 14`, `Community 48`, `Community 50`, `Community 23`, `Community 26`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `useLanguage()` connect `Community 13` to `Community 33`, `Community 2`, `Community 6`, `Community 41`, `Community 11`, `Community 16`, `Community 17`, `Community 50`, `Community 19`, `Community 20`, `Community 21`, `Community 54`?**
...
- **Are the 12 inferred relationships involving `merge()` (e.g. with `atlasProgression()` and `benchDominationProgression()`) actually correct?**
  _`merge()` has 12 INFERRED edges - model-reasoned connections that need verification._
