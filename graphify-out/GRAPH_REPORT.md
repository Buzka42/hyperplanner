# Graph Report - workout planner  (2026-08-13)

## Corpus Check
- 251 files · ~8,013,303 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1127 nodes · 1659 edges · 97 communities detected
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 141 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff123f29`
...
3. `useLanguage()` - 26 edges
4. `cn()` - 22 edges
5. `useUser()` - 21 edges
6. `merge()` - 15 edges
7. `build_theme()` - 12 edges
8. `workSets()` - 12 edges
9. `buildExerciseIntelligence()` - 11 edges
10. `t()` - 11 edges
...
Cohesion: 0.05
Nodes (59): getMuscleContributions(), getBlockFromWorkout(), doubleProgression(), handleSaveSession(), extractPerformanceObservations(), atlasProgression(), accessories(), allSetsReach() (+51 more)
...
Cohesion: 0.06
Nodes (26): UserProvider(), isAccessKeyUsable(), isAlwaysFreePlan(), normalizeKeyword(), withAlwaysFreePlans(), benchmarkLiftsFor(), canonicalPlanId(), canonicalPlanIds() (+18 more)
...
Cohesion: 0.08
Nodes (19): adventureDraftKey(), adventureResultKey(), buildAdventureSequence(), findPreviousAdventureWeight(), getAdventureExercise(), getAdventurePair(), applyHouseProgressions(), houseBalance() (+11 more)
...
Cohesion: 0.09
Nodes (19): analysePlan(), generatesPerVisit(), buildPreviewUser(), buildPreviewVariants(), slotKey(), clampSets(), inScope(), overrideFor() (+11 more)
...
Cohesion: 0.1
Nodes (9): baseWeeklySets(), blockFor(), meetsMinimums(), preprocess(), applyMutation(), phenotype(), proposeMutation(), reallocationCap() (+1 more)
...
Cohesion: 0.2
Nodes (8): save(), toggleFeature(), analyzeVideo(), requestApexVideoAdvice(), videoAdviceAvailable(), analyzeLiftVideo(), loadAiConfig(), toBase64()
...
Cohesion: 0.18
Nodes (4): buildWeightCalculator(), calibrationExercisesFor(), phaseFor(), requiredStatsFor()

### Community 25 - "Community 25"
Cohesion: 0.23
Nodes (6): save(), accessExercisesFor(), nextRomLevel(), selectApexEmphasis(), validRegionScore(), applyApexAccess()
...
Cohesion: 0.53
Nodes (4): applyPendingScheduleMode(), calendarPlanWeek(), clampProgramWeek(), requestScheduleMode()
...
Cohesion: 0.83
Nodes (3): accumulate(), intensify(), roundRest()
...
- **Why does `definePlan()` connect `Community 13` to `Community 1`, `Community 66`, `Community 65`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `Community 42`, `Community 44`, `Community 16`, `Community 49`, `Community 24`, `Community 25`, `Community 57`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `useUser()` connect `Community 22` to `Community 2`, `Community 67`, `Community 4`, `Community 3`, `Community 28`, `Community 19`, `Community 51`, `Community 52`, `Community 27`, `Community 60`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `useLanguage()` connect `Community 22` to `Community 34`, `Community 67`, `Community 4`, `Community 2`, `Community 3`, `Community 28`, `Community 50`, `Community 19`, `Community 51`, `Community 52`, `Community 27`, `Community 60`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Are the 25 inferred relationships involving `empty()` (e.g. with `athenaProgression()` and `accessories()`) actually correct?**
  _`empty()` has 25 INFERRED edges - model-reasoned connections that need verification._
